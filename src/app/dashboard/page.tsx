      ...
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-meridian-100 border-l-4 bg-white p-5 sm:col-span-2" style={{ borderLeftColor: score ? color : "#B5D4F4" }}>
            ...
            {!score && (
              <Link href="/dashboard/audit" className="mt-4 flex items-center justify-center gap-2 rounded-lg bg-meridian-600 py-3 text-sm font-bold text-white transition-colors hover:bg-meridian-800">
        ...
        <div>
          <div className="mb-3 flex items-center justify-between">
            ...
            <Link href="/dashboard/priorities" className="flex items-center gap-1 rounded-lg border border-meridian-100 bg-meridian-50 px-3 py-1.5 text-sm font-bold text-meridian-600 transition-colors hover:bg-meridian-100">
        ...
        {recentChanges.length > 0 && (
          <div>
            <div className="mb-3 flex items-center justify-between">
              ...
              <Link href="/dashboard/monitor" className="flex items-center gap-1 text-sm text-ink-3 transition-colors hover:text-ink-2">View all <ChevronRight className="h-3.5 w-3.5" /></Link>
            </div>
            <div className="space-y-2">
              {recentChanges.map((c: any, i) => (
                <div key={i} className="flex items-center gap-3 rounded-xl border border-meridian-100 bg-white px-4 py-3">
