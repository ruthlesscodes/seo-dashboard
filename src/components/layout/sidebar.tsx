      ...
      <div className="flex flex-1 flex-col overflow-y-auto p-3">
        {(orgName || plan) && (
          <div className="mb-4 flex items-center gap-2 px-2">
            ...
            <span className="rounded-full px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider bg-meridian-50 text-meridian-600">
              {plan}
            </span>
          </div>
        )}
        <nav className="space-y-4">
          {nav.map((group) => (
            <div key={group.label}>
              <p className="mb-2 px-2 text-[11px] font-bold uppercase tracking-[0.08em] text-ink-3">{group.label}</p>
